...
const giveservices = require("./queries/manager/giveservices")
...
//         else{
//             manager = result[0]
//             res.redirect("/manager/managerHomepage")
//         }
//     })
// })

// app.get("/manager/managerHomepage" , (req,res) => {
//     res.render("./manager/managerHomepage.ejs")
// })
...
//     var id = req.body.id
//     var pwd = req.body.pwd
//     addman.add(id,pwd, (result) => {
//         if(result==false)
//         {
//             console.log("Manager not added")
...
app.get("/manager/giveservices" , (req,res) => {
    res.render("./manager/giveservices.ejs")
})
app.post("/manager/giveservices" , (req,res) => {
...
app.get('/manager/getinput',(req,res)=>{
    if(manager == undefined){
        res.redirect('/manager/login')
    } else {
